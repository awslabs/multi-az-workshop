...
export class EKSApplication extends Construct {
  ...
  constructor(scope: Construct, id: string, props: EKSApplicationProps) {
    ...
    const podManagedPolicy = new iam.ManagedPolicy(this, 'PodManagedPolicy', {
    ...
    const podCloudWatchManagedPolicy = new iam.ManagedPolicy(this, 'PodCloudWatchManagedPolicy', {
