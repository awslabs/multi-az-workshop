...
export class AwsLoadBalancerController extends HelmRepoAndChartConstruct {
   ...
   */
  private createAwsLoadBalancerControllerIAMPolicy(version: string): iam.ManagedPolicy {
    ...
    // The policy URL is: https://raw.githubusercontent.com/kubernetes-sigs/aws-load-balancer-controller/${version}/docs/install/iam_policy.json
