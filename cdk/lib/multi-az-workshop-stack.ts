...
export class MultiAZWorkshopStack extends cdk.Stack {
  ...
  private readonly arch: ec2.InstanceArchitecture = ec2.InstanceArchitecture.ARM_64;
  ...
  constructor(scope: Construct, id: string, props: MultiAZWorkshopStackProps) {
    ...
    switch (this.evacuationMethod) {
      case EvacuationMethod.SelfManagedHttpEndpoint_APIG: {
        ...
        this.healthCheckStack = new Route53HealthChecksStack(this, 'health-checks-', {
          ...
          availabilityZoneIdToRoutingControlArns: Object.fromEntries(
            availabilityZoneIds.map((x) => [x, undefined])
          ),
        });
        break;
      }
    ...
    const multiAZObservability = new BasicServiceMultiAZObservability(this, 'basic-service-', {
