...
export class ApplicationStack extends NestedStackWithSource {
  ...
  constructor(scope: cdk.Stack, id: string, props: ApplicationStackProps) {
    ...
    const appContainerImage = new cdk.CustomResource(this, 'AppContainer', {
    ...
    const appContainerWithFaultImage = new cdk.CustomResource(this, 'AppFaultContainer', {
      serviceToken: this.uploaderFunction.functionArn,
      properties: {
        Type: 'Docker',
        Bucket: cdk.Fn.ref('AssetsBucketName'),
    ...
    const cloudwatchAgentContainerImage = new cdk.CustomResource(this, 'CloudWatchAgentContainerImage', {
      serviceToken: this.uploaderFunction.functionArn,
      properties: {
        Type: 'Docker',
        Bucket: cdk.Fn.ref('AssetsBucketName'),
  ...
  private setupContainerBuildProject(): codebuild.IProject {
    ...
    const buildLogGroup = new logs.LogGroup(this, 'BuildProjectLogGroup', {
  ...
  private setupUploader(): lambda.IFunction {
    ...
    const cloudWatchManagedPolicy = new iam.ManagedPolicy(this, 'CloudWatchManagedPolicy', {
      statements: [
        new iam.PolicyStatement({
